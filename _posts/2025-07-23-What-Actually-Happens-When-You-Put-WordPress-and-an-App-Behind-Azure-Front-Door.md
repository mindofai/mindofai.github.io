...
![Azure Front Door Architecture](./images/afd-architecture.png)
...
![Routing Configuration](./images/afd-routes.png)
...
![Header-Based Routing](./images/afd-rule-header.png)
...
![CORS Error Example](./images/cors-error.png)
...
![Route Order](./images/afd-route-order.png)
